@echo off
REM This script will compile the mtdr examples for Windows.
...
set "proto_dir=%repo_root%\src\mtdr\proto"

echo Building mtdr python...
...
set "python_dst_dir=%repo_root%\src\mtdr\python"
cd /d "%python_dst_dir%"
python -m venv .venv
