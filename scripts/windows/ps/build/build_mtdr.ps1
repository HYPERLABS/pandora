<#
This script compiles the mtdr examples for Windows.
...
$protoDir = Join-Path $repoRoot "src\mtdr\proto"
...
Write-Host "Building mtdr python..."
...
$pythonDstDir = Join-Path $repoRoot "src\mtdr\python"
